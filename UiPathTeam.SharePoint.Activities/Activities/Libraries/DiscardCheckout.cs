...
{
    [Description("An activity that discards the check out on a file at a specified url, the check in will happen under the account specified in the SP Application Scope")]
    public class DiscardCheckout : SharePointCodeActivity
    {
        [Category("Input")]
        [RequiredArgument]
        ...
        public DiscardCheckout() : base(false)
        {
        ...
        //    Utils.DiscardCheckOut(clientContext, relativeUrl);
        //}
        ...
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
        {
            ...
            var task = service.DiscardCheckoutAsync(relativeUrl);

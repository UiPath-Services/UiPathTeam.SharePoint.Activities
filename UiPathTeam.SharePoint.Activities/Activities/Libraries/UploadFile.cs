...
namespace UiPathTeam.SharePoint.Activities.Libraries
{
    ...
    public sealed class UploadFile : CreateFile
    {
        ...
        //    Microsoft.SharePoint.Client.File uploadedFile = Utils.UploadFile(clientContext, relativeUrl, localpath, propertiesDictionary, AllowOverwrite, customContext.groupQueries);
        ...
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
        {
            ...
            var task = service.UploadFileAsync(relativeUrl, localpath, propertiesDictionary, AllowOperationsOnASPXFiles, AllowOverwrite, CheckOutFileBeforeOverwrite, CheckInFileAfterCreation);

...
{
    public class AddUserToGroup : SharePointCodeActivity
    {
        [Category("Input")]
        [RequiredArgument]
        [Description("The name of the group where the user should be added")]
        public InArgument<string> GroupName { get; set; }

        [Category("Input")]
        [RequiredArgument]
        [Description("String representing either the domain/username or the email of the user that needs to be added")]
        public InArgument<string> User { get; set; }

        public AddUserToGroup() : base(true)
        {
            ShowUserName = true;
            ShowGroupName = true;
        }
        ...
        //    Utils.AddUserToGroup(spContext, userIdentification, groupName, customContext.groupQueries);
        //}
        ...
        protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
        {
            ...
            var task = service.AddUserToGroupAsync(groupName, userIdentification);
